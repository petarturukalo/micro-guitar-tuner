...
/**
 * @brief Set the bit at row i, column j of the 2D bit array to value.
 * @param ncols Must be a multiple of BITS_IN_BYTE.
 */
...
/**
 * @brief Copy a ncols by nrows source 2D bit array to a destination 2D bit array.
 * @param ncols Must be a multiple of BITS_IN_BYTE.
 */
